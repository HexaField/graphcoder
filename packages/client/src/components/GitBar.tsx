...
export const GitBar: Component = () => {
  // No createEffect here — auto-load is handled imperatively in toggleGitBar()
  // (temporal.ts). Using createEffect for this causes a reactive loop:
  // loadCommits() clears commits synchronously, which re-fires any effect that
  // reads commits.length, creating thousands of concurrent fetch requests.
